...
$areaGap: 10px;
$dataAreaBorderColor: #fff9;
$dataAreaBorderColorHydrogen: #0003;
...
.data-page {
  ...
  width: 100%;
  height: 100vh;
  transition: background-color pt.$dataPageTurnDuration;
  z-index: 300;
  ...
  &__main-info-icon {
    ...
    transition: filter pt.$dataPageTurnDuration;
    &.is-category-h {
  ...
  &__close-button {
    ...
    height: 50px;
    filter: drop-shadow(0 0 3px #0002);
    transition: transform 0.3s, filter pt.$dataPageTurnDuration;
    z-index: 301;
    @include g.breakpointMax() {
      right: 20px;
    }
...
:deep() .data-area {
  ...
  height: 100%;
  border-radius: 7px;
  border: 2px solid $dataAreaBorderColor;
  color: pt.$colorWhite;
  background: #0002;
  transition-property: border-color, background-color, color;
  transition-duration: pt.$dataPageTurnDuration;
  &.is-category-h {
    border-color: $dataAreaBorderColorHydrogen;
  ...
  &__item-kanji-copy-button {
    ...
    border: 16px solid $dataAreaBorderColor;
    transition-property: border-color;
    transition-duration: pt.$dataPageTurnDuration;
    @include g.breakpointMax() {
      border: 14px solid $dataAreaBorderColor;
      border-radius: 12px 0 3px 0;
    }
    &.is-category-h {
      border: 16px solid $dataAreaBorderColorHydrogen;
      @include g.breakpointMax() {
        border: 14px solid $dataAreaBorderColorHydrogen;
      }
    }
  }
